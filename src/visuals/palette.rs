...
pub fn color_brewer_set2_palette() -> Vec<Color> {
    vec![
        Color::rgb(102, 194, 165), // Teal
        Color::rgb(252, 141, 98),  // Salmon
        Color::rgb(141, 160, 203), // Lavender
        Color::rgb(231, 138, 195), // Pink
        Color::rgb(166, 216, 84),  // Light Green
        Color::rgb(255, 217, 47),  // Light Yellow
        Color::rgb(229, 196, 148), // Beige
...
pub fn viridis_palette() -> Vec<Color> {
    vec![
        ...
        Color::rgb(33, 144, 141),
        Color::rgb(39, 173, 129),
        Color::rgb(92, 200, 99),
...
fn cielab_to_rgb(l: f64, a: f64, b: f64) -> (u8, u8, u8) {
    ...
    let clamp = |c: f64| -> u8 { (c.max(0.0).min(1.0) * 255.0).round() as u8 };
